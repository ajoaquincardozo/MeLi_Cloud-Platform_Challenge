...
def analyze_solution(solution_path, definition):
    layers = {
        'MeLi.UrlShortener.Api': process_layer,
        'MeLi.UrlShortener.Application': process_layer,
        'MeLi.UrlShortener.Domain': process_layer,
        'MeLi.UrlShortener.Infrastructure': process_layer
    }
    ...
    # Use the output_path from the definition, or fall back to the default
    results_folder = os.path.join(definition.get('output_path', 'analysis_results'), analysis_name)
...
def load_definition(definition_path):
    default_definition = {
        "name": "unnamed",
        "solution_path": "./",
        "output_path": "analysis_results",  # Added default output path
        "layers": [
            "MeLi.UrlShortener.Api",
            "MeLi.UrlShortener.Application",
            "MeLi.UrlShortener.Domain",
            "MeLi.UrlShortener.Infrastructure"
        ],
...
if __name__ == "__main__":
    ...
    print(f"Output path: {definition.get('output_path', 'analysis_results')}")
